...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{../output/figures/response_time_comparison.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\textwidth]{../output/figures/composite_cross_domain_overview.png}
